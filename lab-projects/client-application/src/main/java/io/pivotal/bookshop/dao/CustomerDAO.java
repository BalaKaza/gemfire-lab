...
public class CustomerDAO extends DAOCommon<Integer, Customer> {
     ...
     *
     * @param key Key for customer to fetch
    ...
    public String getCustomerName(Integer key) {
        ...
        if (customerEntry instanceof PdxInstance) {
            String firstName = String.valueOf(((PdxInstance) customerEntry).getField("firstName"));
            String lastName = String.valueOf(((PdxInstance) customerEntry).getField("lastName"));
