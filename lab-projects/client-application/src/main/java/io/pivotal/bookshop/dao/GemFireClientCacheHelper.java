...
public class GemFireClientCacheHelper {
     ...
     *
     * @param readSerialized Boolean indicating whether the client cache should be
     ...
     *
     * @param cache                ClientCache to use for creating the ClientRegionFactory
     * @param regionName           Name of the region to initialize
     * @param createAsCachingProxy Boolean indicating wither region should be a caching proxy
     */
